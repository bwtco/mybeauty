...
odoo.define('tax_invoice_with_barcode.models_inherit', function (require) {
    'use strict';
                        ...
                        var done =  new Promise(function (resolveDone, rejectDone) {
                            ...
                            transfer.then(function(order_server_id){
                                ...
                                if (order_server_id.length && !order.is_to_email()) {
                                    self.chrome.do_action('tax_invoice_with_barcode.tax_barcode_account_invoices',{additional_context:{
